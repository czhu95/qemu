...
static void plugin_vcpu_cb__simple(CPUState *cpu, enum qemu_plugin_event ev)
{
    ...
    case QEMU_PLUGIN_EV_VCPU_INTERRUPT_RET:
...
{
    plugin_vcpu_cb__simple(cpu, QEMU_PLUGIN_EV_VCPU_INTERRUPT_RET);
}

void qemu_plugin_register_vcpu_interrupt_ret_cb(qemu_plugin_id_t id,
                                            qemu_plugin_vcpu_simple_cb_t cb)
{
    plugin_register_cb(id, QEMU_PLUGIN_EV_VCPU_INTERRUPT_RET, cb);
}
